...
export default function Sidebar({ activeTab, setActiveTab }: SidebarProps) {
  return (
    <div className="w-64 bg-[#0a0a0a] border-r border-gray-800 flex flex-col z-20 hidden md:flex">
      ...
      <div className="flex-1 py-6 flex flex-col gap-2 px-4 overflow-y-auto">
        <div className="text-xs font-mono text-gray-500 uppercase tracking-widest mb-2 px-2">Core Modules</div>
        {navItems.map((item) => (
          <button
            key={item.id}
